"""
Django settings for LaCasaDeLaPradera project.
...
SECRET_KEY = "django-insecure-%(4v!6roa3a4g-2n^0dph+(%gw^v%n$6t*7-mjwbdq9jl(x)ia"
...
MIDDLEWARE = [
    ...
    "personal.middleware.ForcePasswordChangeMiddleware",
    "django.contrib.messages.middleware.MessageMiddleware",
    "django.middleware.clickjacking.XFrameOptionsMiddleware",
]

ROOT_URLCONF = "LaCasaDeLaPradera.urls"
...
WSGI_APPLICATION = "LaCasaDeLaPradera.wsgi.application"
...
LOGIN_URL = '/usuarios/login/'              # si alguien no logeado intenta entrar, lo lleva aquí
